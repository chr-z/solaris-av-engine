    ...
    <div className="p-6 max-w-5xl mx-auto text-gray-200" data-testid="admin-rules-panel">
      <header className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-2">
          <button onClick={startCreate} className="px-3 py-1.5 rounded-md bg-solar-accent text-white hover:bg-solar-accent-hover text-sm">
            Nova regra
          </button>
      ...
      {editingId !== null && (
        <section aria-label="Editor de regra" className="mb-6 p-4 rounded-lg bg-solar-dark-content/70 border border-solar-dark-border space-y-3">
          ...
          <div className="flex gap-2 pt-2">
            <button onClick={saveDraft} className="px-4 py-1.5 rounded-md bg-solar-accent text-white hover:bg-solar-accent-hover text-sm">
              Salvar
            </button>

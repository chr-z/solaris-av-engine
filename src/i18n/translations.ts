...
export const en = {
  ...
  'dash.live.colRework': 'Rework (audit)',
  'dash.live.colVsTeam': 'vs team',
  'dash.live.reworkOf': '{ok} ok / {bad} rework',
  'dash.live.vsTeamSlow': '+{pct}% slower',
  'dash.live.vsTeamFast': '−{pct}% faster',
  'dash.live.vsTeamEven': 'on par',
...
export const pt: Record<TranslationKey, string> = {
  ...
  'dash.live.colRework': 'Retrabalho (auditoria)',
  'dash.live.colVsTeam': 'vs time',
  'dash.live.reworkOf': '{ok} ok / {bad} retrabalho',
  'dash.live.vsTeamSlow': '+{pct}% mais lento',
  'dash.live.vsTeamFast': '−{pct}% mais rápido',
  'dash.live.vsTeamEven': 'na média',
